        ...
        <div>
            <div className="container-fluid">
                ...
                height: " 90vh",
                    ...
                    <img src={`https://image.tmdb.org/t/p/w200${series.poster_path}`} className='details-img' />
                    </div>
                    <div className="col-md-6 text-start px-3 py-5">
                    <h1>{series.title}</h1>
                    <p>Release Date: {series.release_date}</p>
                    <span style={{marginRight:"30px", color:"white"}}> Rating: {series.vote_average}</span>
                    <span style={{color:"white"}}>Language: {series.original_language}</span>
                    ...
                    <Link className="btn btn-primary" style={{marginTop:"20px"}} to="/">Add to watchlist</Link>
                    </div>
                </div>
            </div>
        </div>    
