      ...
      <Slider {...settings} className='slider'>
        {
          movies.map((m)=>(
            <div className="background">
              <img src={`https://image.tmdb.org/t/p/w500`+m.backdrop_path} alt="" className='backimage'/>
              <div className="movvcard">
                <img src={`https://image.tmdb.org/t/p/w500`+m.poster_path} alt="" className='cardimg'/>
              </div>
            </div>
